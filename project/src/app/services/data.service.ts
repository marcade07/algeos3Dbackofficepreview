...
export class DataService {
  ...
  getAllTimeMetrics(): Observable<MetricCard[]> {
    return of([
      ...
      },
      {
        ...
        value: '456',
        trend: { direction: 'up', percentage: '67.3%' },
        icon: 'bi-people'
      },
      {
  ...
  getOtherProducts(): Observable<Product[]> {
    return of([
      // Keep only the first existing product
      {
        id: 1,
    ...
    return of([
      {
        ...
        trackingPattern: 'https://www.royalmail.com/track-your-item#/tracking-results/{tracking_number}',
        contactInfo: '03457 740 740',
        status: 'Active'
      },
      {
        id: 2,
        ...
        trackingPattern: 'https://www.dpd.co.uk/apps/tracking/?reference={tracking_number}',
        contactInfo: '0121 275 0500',
        status: 'Active'
      },
      {
        id: 3,
        ...
        trackingPattern: 'https://www.ups.com/track?loc=en_GB&tracknum={tracking_number}',
        contactInfo: '03457 877 877',
        status: 'Active'
      },
      {
        id: 4,
        name: 'Hermes',
        serviceType: 'Economy',
        trackingPattern: 'https://www.myhermes.co.uk/track#/parcel/{tracking_number}',
        contactInfo: '0330 808 5456',
        status: 'Inactive'
      },
      {
        id: 5,
        ...
        trackingPattern: 'https://www.fedex.com/apps/fedextrack/?action=track&trackingnumber={tracking_number}',
        contactInfo: '0345 600 0068',
        status: 'Active'
      }
    ]);
  }
